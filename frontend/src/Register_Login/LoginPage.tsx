    ...
    return (
        <div className={"login-form-wrapper"}>
            ...
            <div className={"login-form"}>
                ...
                <a href={`https://accounts.spotify.com/authorize?response_type=code&client_id=3ed8e5d98a3b469db405d1bb01652723&scope=streaming user-read-playback-state user-read-private user-modify-playback-state user-read-email playlist-read-private playlist-read-collaborative playlist-modify-public playlist-modify-private&redirect_uri=https://soundtracker-xl.herokuapp.com/spotify-redirect`}>Login With Spotify</a>
            </div>
        </div>
    )
}
